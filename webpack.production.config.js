...
module.exports = {
  ...
  output: {
    ...
    publicPath: "/",
    filename: "public/[name].[chunkhash].js", //this will provide hash value automatically
  },
  resolve: {
  ...
  plugins: [
    ...
    // new ExtractTextPlugin("public/css/[name].[hash].css"), //generates new bundle for css
